...
function plot_focussed_bdpdf()
    csv_data_path = "data/P20/15_02_2024_P20_Ch14_FRQ=10Hz_FULL_CL_phase=0_REST_EC_v1"
    df_bdpdf_data_rest = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)   
    
    #0vs180
    p1 = plot(
        df_bdpdf_data_rest[!, 1],
        df_bdpdf_data_rest[!, 2], 
        xlabel="Amplitude",
        ylabel="PDF Change",
        title="0 (o) vs. 180 (g)",
        legend=false,
    ...
    df_bdpdf_data_stim_0 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p1, df_bdpdf_data_stim_0[!, 1], df_bdpdf_data_stim_0[!, 2], linewidth=3)
    csv_data_path = "data/P20/15_02_2024_P20_Ch14_FRQ=10Hz_FULL_CL_phase=180_STIM_EC_v1"
    df_bdpdf_data_stim_180 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p1, df_bdpdf_data_stim_180[!, 1], df_bdpdf_data_stim_180[!, 2], linewidth=3)
    ...
    df_bdpdf_data_stim_45 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p2, df_bdpdf_data_stim_45[!, 1], df_bdpdf_data_stim_45[!, 2], linewidth=3)
    csv_data_path = "data/P20/15_02_2024_P20_Ch14_FRQ=10Hz_FULL_CL_phase=225_STIM_EC_v1"
    df_bdpdf_data_stim_225 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p2, df_bdpdf_data_stim_225[!, 1], df_bdpdf_data_stim_225[!, 2], linewidth=3)
    ...
    df_bdpdf_data_stim_90 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p3, df_bdpdf_data_stim_90[!, 1], df_bdpdf_data_stim_90[!, 2], linewidth=3)
    csv_data_path = "data/P20/15_02_2024_P20_Ch14_FRQ=10Hz_FULL_CL_phase=270_STIM_EC_v1"
    df_bdpdf_data_stim_270 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p3, df_bdpdf_data_stim_270[!, 1], df_bdpdf_data_stim_270[!, 2], linewidth=3)
    ...
    df_bdpdf_data_stim_135 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p4, df_bdpdf_data_stim_135[!, 1], df_bdpdf_data_stim_90[!, 2], linewidth=3)
    csv_data_path = "data/P20/15_02_2024_P20_Ch14_FRQ=10Hz_FULL_CL_phase=270_STIM_EC_v1"
    df_bdpdf_data_stim_315 = CSV.read(csv_data_path*"/bdpdf.csv", DataFrame)  
    plot!(p4, df_bdpdf_data_stim_315[!, 1], df_bdpdf_data_stim_315[!, 2], linewidth=3)

    plot(p1, p2, p3, p4, layout=grid(2, 2))
    savefig("focussed-bdpdf-data.png")
    ...
    plot(p1, p2, p3, p4, layout=grid(2, 2))
    savefig("focussed-bdpdf-model.png")
    ...
    p1 = plot(
        df_bdpdf_data_rest[!, 1],
        [0.0 for i in df_bdpdf_data_rest[!, 2]], 
        xlabel="Amplitude",
        ylabel="PDF Change",
        title="0 (o) vs. 180 (g)",
        legend=false,
    ...
    plot!(p1, df_bdpdf_data_stim_0[!, 1], (df_bdpdf_data_stim_0[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    plot!(p1, df_bdpdf_data_stim_180[!, 1], (df_bdpdf_data_stim_180[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    ...
    plot!(p2, df_bdpdf_data_stim_45[!, 1], (df_bdpdf_data_stim_45[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    plot!(p2, df_bdpdf_data_stim_225[!, 1], (df_bdpdf_data_stim_225[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    ...
    plot!(p3, df_bdpdf_data_stim_90[!, 1], (df_bdpdf_data_stim_90[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    plot!(p3, df_bdpdf_data_stim_270[!, 1], (df_bdpdf_data_stim_270[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    ...
    plot!(p4, df_bdpdf_data_stim_135[!, 1], (df_bdpdf_data_stim_135[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)
    plot!(p4, df_bdpdf_data_stim_315[!, 1], (df_bdpdf_data_stim_315[!, 2]  .- df_bdpdf_data_rest[!, 2]) ./ df_bdpdf_data_rest[!,2], linewidth=3)

    plot(p1, p2, p3, p4, layout=grid(2, 2))
    savefig("focussed-bdpdf-diff.png")
    ...
    plot(p1, p2, p3, p4, layout=grid(2, 2))
    savefig("focussed-bdpdf-diff-model.png")
