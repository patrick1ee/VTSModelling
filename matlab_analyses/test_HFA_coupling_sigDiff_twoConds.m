function [] = test_HFA_coupling_sigDiff_twoConds(Paths, Const, REF_TYPE, LOCAL_HFA)
...
%% P1
% cond1 = {  '-20',    '-20',    '-20',    '-20',    '-20',    '-20'};
% cond1 = {  '25',    '25',    '25',  '25',   '25',  '25' ,  '25'};
% cond2 = { '-20',   '-65',   '70',  '115',  '160',  '205',  '250'};
% 
% cond1 = {  '160',    '160',    '160',  '160',   '160',  '160' ,  '160'};
% cond2 = { '-20',   '-65',   '70',  '115',  '25',  '205',  '250'};
% 
% WIN_START = 5; %sec
% WIN_END   = 55; %sec

% cond1 = {' noStim',' noStim', ' noStim', ' noStim', ' noStim', ' noStim',' noStim',' noStim'};
% cond2 = {  '-20',  '-65',     '25',       '70',      '115',    '160',     '205',    '250'};

%% P2 - Petra
cond1 = {' noStim', ' noStim', ' noStim', ' noStim', ' noStim', ' noStim', ' noStim',   ' noStim'};
cond2 = {'0',       '45',      '90',      '135',     '180',     '225',     '270',       '315'};

% cond1 = {  '0',  '0',    '0',    '0',    '0',    '0',    '0'};
% cond2 = { '45', '90',  '135',  '180',  '225',  '270',  '315'};
% 
% 
% cond1 = {  '180',  '180',    '180',    '180',    '180',    '180',    '180'};
% cond2 = { '0', '45', '90',  '135',  '225',  '270',  '315'};
...
for p = 1:numel(Const.participants)
    ...
    for v = 1:2
        ...
        for c = 1:numel(cond1)
            ...
            fileNames{1} = fileNames_tmp{strcmp(cond1(c), shortNames)==1};
            fileNames{2} = fileNames_tmp{strcmp(cond2(c), shortNames)==1};
    ...
    %             plot(EEG_data)
            ...
            %     plot(find(abs(med_abs_dev_scores) > OUTL_THRESHOLD), EEG_data(abs(med_abs_dev_scores) > OUTL_THRESHOLD), 'x', 'Color', 'r')
                ...
                data_tag = [data_tag; ones(size(alpha_phase)) * fn];
...
%             legend([p1 p2], cond1{c}, cond2{c})
            set(gca, 'FontSize', 9)
            title([cond1{c}, ' vs ', cond2{c}])
        end
        
        if ~exist([Paths.plots, 'HFA_diff_twoConds/', currSubj, '/', cond1{c}, '/'])
            mkdir([Paths.plots, 'HFA_diff_twoConds/', currSubj, '/', cond1{c}, '/'])
        end
        saveas(fig_h, [Paths.plots, 'HFA_diff_twoConds/', currSubj, '/', cond1{c}, '/HFA_diff_twoConds_ref=', cond1{c}, '_', currSubj, '_', vers, '_', LOCAL_HFA, addit, '.jpg'])
